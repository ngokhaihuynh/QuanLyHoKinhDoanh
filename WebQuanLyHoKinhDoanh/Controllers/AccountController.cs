...
using WebQuanLyHoKinhDoanh.Helper;
using WebQuanLyHoKinhDoanh.Models;

namespace WebQuanLyHoKinhDoanh.Controllers
{
    [Authorize]
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    {
                        AuthenticationManager.SignOut(DefaultAuthenticationTypes.ApplicationCookie); // xoa cookie
                        return View("NotificationEmailConfirm"); // hiển thị trang confirm email
                    }
                    else
